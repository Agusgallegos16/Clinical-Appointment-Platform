    ...
    const confirmar = async () => {
      try {
        ...
        setError(
          ...
          'El enlace de activación es inválido o ha expirado. Por favor solicite una nueva cuenta.'
        );
      } finally {
        setLoading(false);
      }
          ...
          {loading ? (
            ...
            <Box py={2} display="flex" flexDirection="column" alignItems="center" gap={2}>
              ...
              <Typography variant="body1" color="text.secondary" paragraph>
                Tu cuenta ha sido activada correctamente y te hemos enviado el email de bienvenida. Serás redirigido al inicio de sesión en unos segundos...
              </Typography>
              <Button
                variant="contained"
                color="primary"
